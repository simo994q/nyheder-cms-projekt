import { getTechnology } from "../../queries/getTechnology"
...
export const Technology = () => {
    ...
    const { data, isLoading, error } = useQuery({
        ...
        queryFn: async () => request(`https://eu-central-1-shared-euc1-02.cdn.hygraph.com/content/clnij52rt05rg01ue9cvq8ycn/master`, getTechnology)
    })
